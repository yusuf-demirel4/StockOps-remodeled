...
- Name: critical-paths.spec.ts >> Critical Paths — Smoke Tests >> Authenticated flows >> customers sayfası yüklenir
- Location: e2e\critical-paths.spec.ts:91:9
...
Expected pattern: /customers|müşteri/i
